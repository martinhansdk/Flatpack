...
TEST_CASE("segmentsIntersect", "[geometry]") {
    ...
    SECTION("collinear overlapping") { REQUIRE(segmentsIntersect({0, 0}, {2, 0}, {1, 0}, {3, 0})); }
...
TEST_CASE("pointInPolygon", "[geometry]") {
    ...
    SECTION("clearly inside") { REQUIRE(pointInPolygon({2, 2}, square)); }

    SECTION("clearly outside") { REQUIRE_FALSE(pointInPolygon({5, 5}, square)); }

    SECTION("outside left") { REQUIRE_FALSE(pointInPolygon({-1, 2}, square)); }

    SECTION("outside below") { REQUIRE_FALSE(pointInPolygon({2, -1}, square)); }
    ...
    SECTION("empty polygon") { REQUIRE_FALSE(pointInPolygon({1, 1}, polygon_t{})); }
}
